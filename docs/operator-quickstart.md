# Operator Quickstart — Gambling and betting activities

Shortest path from clone to a verified local dry-run for **ISIC 9200** (`cloud-itonami-isic-9200`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-9200.git
cd cloud-itonami-isic-9200
```
...
- Blueprint governor key: `responsible-gambling-governor`
- Likely source path: `wagering.governor.cljc`
